...
export const Route = createFileRoute("/devocional")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Versículo do dia, reflexão curta e convite para o devocional matinal nas lives da carolzyn." },
      { property: "og:title", content: "Devocional cozy — carolzyn" },
      { property: "og:description", content: "Um momento calmo pra respirar, orar e tomar um café." },
    ],
  }),
      ...
      <section className="relative">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Um pedacinho de paz no meio do dia. Sem pressa, sem peso — só você, sua bebida favorita e uma palavra calma.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-20 px-6">
        ...
        >
          <div className="bg-card border-2 border-sage/20 p-12 lg:p-14 rounded-[40px] shadow-2xl shadow-sage/5 relative">
            ...
            <span className="absolute top-6 left-7 text-7xl text-sage/20 font-serif leading-none">"</span>
      ...
      <section className="py-20 px-6 bg-muted/40">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            O devocional dos filhotes acontece toda <strong className="text-foreground">segunda-feira às 09:00</strong>,
            ao vivo na Twitch. Café, oração e papo bom.
          </p>
          <a
