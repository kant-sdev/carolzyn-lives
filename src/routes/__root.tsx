  ...
  head: () => ({
    meta: [
      ...
      { title: "carolzyn — um cantinho cozy para os filhotes" },
      {
        name: "description",
        content:
          "O cantinho aconchegante da streamer carolzyn: lives, devocional e comunidade dos filhotes.",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen flex flex-col bg-background text-foreground selection:bg-warm-orange/25">
        <Navbar />
